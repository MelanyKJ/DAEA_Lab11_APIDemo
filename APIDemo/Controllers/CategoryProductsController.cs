...
namespace APIDemo.Controllers
{
    ...
    public class CategoryProductsController : ControllerBase
    {
        ...
        public CategoryProductsController(DemoContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<CategoryProduct>> PostCategoryProduct(CategoryProduct categoryProduct)
        {
          if (_context.CategoryProducts == null)
          {
              return Problem("Entity set 'DemoContext.CategoryProducts'  is null.");
          }
            _context.CategoryProducts.Add(categoryProduct);
            await _context.SaveChangesAsync();

            return CreatedAtAction("GetCategoryProduct", new { id = categoryProduct.CategoryProductId }, categoryProduct);
        }
        ...
        {
            return (_context.CategoryProducts?.Any(e => e.CategoryProductId == id)).GetValueOrDefault();
        }
    }
}
